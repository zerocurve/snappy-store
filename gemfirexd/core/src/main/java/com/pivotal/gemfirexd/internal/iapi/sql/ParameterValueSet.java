/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.ParameterValueSet
...
// GemStone changes BEGIN
	// 0 indicates true, else gives parameter index that failed
	int allAreSet();
	/* (original code)
	boolean	allAreSet();
	*/
// GemStone changes END
	...
	*/
	...
	public int getPrecision(int parameterIndex);
        ...
        /**
         * This controls whether to clear up the BaseActivation#pvs.
         * Applicable only for Subqueries to avoid leaks.
         * 
         * @return
         */
        // for bug #42484
