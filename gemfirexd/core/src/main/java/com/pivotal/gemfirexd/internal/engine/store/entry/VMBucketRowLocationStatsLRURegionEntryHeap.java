...
public class VMBucketRowLocationStatsLRURegionEntryHeap extends RowLocationStatsLRURegionEntry
{
  public VMBucketRowLocationStatsLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
          value
  ...
  private static final AtomicLongFieldUpdater<VMBucketRowLocationStatsLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationStatsLRURegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMBucketRowLocationStatsLRURegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMBucketRowLocationStatsLRURegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMBucketRowLocationStatsLRURegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMBucketRowLocationStatsLRURegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMBucketRowLocationStatsLRURegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMBucketRowLocationStatsLRURegionEntryHeap.class;
    }
