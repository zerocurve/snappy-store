...
{
  public VersionedBucketRowLocationThinLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedBucketRowLocationThinLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedBucketRowLocationThinLRURegionEntryOffHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    ...
    public final Class<?> getEntryClass() {
      return VersionedBucketRowLocationThinLRURegionEntryOffHeap.class;
    }
