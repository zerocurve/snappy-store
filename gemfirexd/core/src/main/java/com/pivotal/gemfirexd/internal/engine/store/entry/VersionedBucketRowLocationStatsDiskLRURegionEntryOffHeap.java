...
public class VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap extends RowLocationStatsDiskLRURegionEntry
    implements OffHeapRegionEntry, VersionStamp
{
  public VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private final static AtomicLongFieldUpdater<VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap.class;
    }
