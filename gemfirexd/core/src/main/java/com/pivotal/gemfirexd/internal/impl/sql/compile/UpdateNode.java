/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.UpdateNode
...
//      GemStone changes BEGIN
       ...
       @Override
        ...
        {
          try {
           //Check for the where clause & see if it contains 
           // a primary key with an equality condition    
