...
public class VersionedLocalRowLocationThinDiskRegionEntryOffHeap extends RowLocationThinDiskRegionEntry
    implements OffHeapRegionEntry, VersionStamp
{
  public VersionedLocalRowLocationThinDiskRegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationThinDiskRegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationThinDiskRegionEntryOffHeap.class, "lastModified");
  ...
  private final static AtomicLongFieldUpdater<VersionedLocalRowLocationThinDiskRegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationThinDiskRegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationThinDiskRegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationThinDiskRegionEntryOffHeap.class;
    }
    ...
    public RegionEntryFactory makeOnHeap() {
      return VersionedLocalRowLocationThinDiskRegionEntryHeap.getEntryFactory();
    }
  };
