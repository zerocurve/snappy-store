...
public class VersionedLocalRowLocationStatsDiskRegionEntryHeap extends RowLocationStatsDiskRegionEntry
    implements VersionStamp
{
  public VersionedLocalRowLocationStatsDiskRegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationStatsDiskRegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationStatsDiskRegionEntryHeap.class;
    }
