...
public class VersionedBucketRowLocationStatsDiskRegionEntryHeap extends RowLocationStatsDiskRegionEntry
    implements VersionStamp
{
  public VersionedBucketRowLocationStatsDiskRegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedBucketRowLocationStatsDiskRegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedBucketRowLocationStatsDiskRegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedBucketRowLocationStatsDiskRegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedBucketRowLocationStatsDiskRegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedBucketRowLocationStatsDiskRegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedBucketRowLocationStatsDiskRegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedBucketRowLocationStatsDiskRegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedBucketRowLocationStatsDiskRegionEntryHeap.class;
    }
