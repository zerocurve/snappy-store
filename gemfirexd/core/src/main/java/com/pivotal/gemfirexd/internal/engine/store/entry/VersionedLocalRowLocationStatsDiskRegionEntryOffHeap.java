...
public class VersionedLocalRowLocationStatsDiskRegionEntryOffHeap extends RowLocationStatsDiskRegionEntry
    implements OffHeapRegionEntry, VersionStamp
{
  public VersionedLocalRowLocationStatsDiskRegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private final static AtomicLongFieldUpdater<VersionedLocalRowLocationStatsDiskRegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationStatsDiskRegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationStatsDiskRegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationStatsDiskRegionEntryOffHeap.class;
    }
    ...
    public RegionEntryFactory makeOnHeap() {
      return VersionedLocalRowLocationStatsDiskRegionEntryHeap.getEntryFactory();
    }
  };
