...
public class VersionedBucketRowLocationStatsLRURegionEntryOffHeap extends RowLocationStatsLRURegionEntry
    implements OffHeapRegionEntry, VersionStamp
{
  public VersionedBucketRowLocationStatsLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedBucketRowLocationStatsLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedBucketRowLocationStatsLRURegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedBucketRowLocationStatsLRURegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedBucketRowLocationStatsLRURegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedBucketRowLocationStatsLRURegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedBucketRowLocationStatsLRURegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private final static AtomicLongFieldUpdater<VersionedBucketRowLocationStatsLRURegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VersionedBucketRowLocationStatsLRURegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedBucketRowLocationStatsLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedBucketRowLocationStatsLRURegionEntryOffHeap.class;
    }
    ...
    public RegionEntryFactory makeOnHeap() {
      return VersionedBucketRowLocationStatsLRURegionEntryHeap.getEntryFactory();
    }
  };
