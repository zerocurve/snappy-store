...
public class VersionedLocalRowLocationThinLRURegionEntryOffHeap extends RowLocationThinLRURegionEntry
    implements OffHeapRegionEntry, VersionStamp
{
  public VersionedLocalRowLocationThinLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationThinLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationThinLRURegionEntryOffHeap.class, "lastModified");
  ...
  private final static AtomicLongFieldUpdater<VersionedLocalRowLocationThinLRURegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationThinLRURegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationThinLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationThinLRURegionEntryOffHeap.class;
    }
    ...
    public RegionEntryFactory makeOnHeap() {
      return VersionedLocalRowLocationThinLRURegionEntryHeap.getEntryFactory();
    }
  };
