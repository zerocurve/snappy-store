...
public class VMLocalRowLocationThinLRURegionEntryHeap extends RowLocationThinLRURegionEntry
{
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationThinLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinLRURegionEntryHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    ...
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationThinLRURegionEntryHeap.class;
    }
