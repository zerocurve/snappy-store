...
public class VersionedLocalRowLocationStatsRegionEntryHeap extends RowLocationStatsRegionEntry
    implements VersionStamp
{
  public VersionedLocalRowLocationStatsRegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
          value
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationStatsRegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationStatsRegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsRegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsRegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsRegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsRegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationStatsRegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationStatsRegionEntryHeap.class;
    }
