...
public class VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap extends RowLocationStatsDiskLRURegionEntry
    implements OffHeapRegionEntry, VersionStamp
{
  public VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationStatsDiskLRURegionEntryOffHeap.class;
    }
    ...
    public RegionEntryFactory makeOnHeap() {
      return VersionedLocalRowLocationStatsDiskLRURegionEntryHeap.getEntryFactory();
    }
  };
