...
public class VMLocalRowLocationThinDiskLRURegionEntryOffHeap extends RowLocationThinDiskLRURegionEntry
    implements OffHeapRegionEntry
{
  public VMLocalRowLocationThinDiskLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationThinDiskLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinDiskLRURegionEntryOffHeap.class, "lastModified");
  ...
  private final static AtomicLongFieldUpdater<VMLocalRowLocationThinDiskLRURegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinDiskLRURegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationThinDiskLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationThinDiskLRURegionEntryOffHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedLocalRowLocationThinDiskLRURegionEntryOffHeap.getEntryFactory();
    }
    @Override
    public RegionEntryFactory makeOnHeap() {
      return VMLocalRowLocationThinDiskLRURegionEntryHeap.getEntryFactory();
    }
  };
