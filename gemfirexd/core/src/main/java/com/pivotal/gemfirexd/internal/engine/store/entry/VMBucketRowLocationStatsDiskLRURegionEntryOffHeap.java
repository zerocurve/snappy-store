...
public class VMBucketRowLocationStatsDiskLRURegionEntryOffHeap extends RowLocationStatsDiskLRURegionEntry
    implements OffHeapRegionEntry
{
  public VMBucketRowLocationStatsDiskLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private final static AtomicLongFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMBucketRowLocationStatsDiskLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMBucketRowLocationStatsDiskLRURegionEntryOffHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedBucketRowLocationStatsDiskLRURegionEntryOffHeap.getEntryFactory();
    }
    @Override
    public RegionEntryFactory makeOnHeap() {
      return VMBucketRowLocationStatsDiskLRURegionEntryHeap.getEntryFactory();
    }
  };
