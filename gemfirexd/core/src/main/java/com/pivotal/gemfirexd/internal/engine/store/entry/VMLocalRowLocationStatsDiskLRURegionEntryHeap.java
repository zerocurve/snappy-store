...
public class VMLocalRowLocationStatsDiskLRURegionEntryHeap extends RowLocationStatsDiskLRURegionEntry
{
  public VMLocalRowLocationStatsDiskLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationStatsDiskLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationStatsDiskLRURegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsDiskLRURegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsDiskLRURegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsDiskLRURegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsDiskLRURegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationStatsDiskLRURegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationStatsDiskLRURegionEntryHeap.class;
    }
