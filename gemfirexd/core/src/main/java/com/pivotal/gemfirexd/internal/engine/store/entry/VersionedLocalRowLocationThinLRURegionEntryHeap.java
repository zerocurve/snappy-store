...
public class VersionedLocalRowLocationThinLRURegionEntryHeap extends RowLocationThinLRURegionEntry
    implements VersionStamp
{
  public VersionedLocalRowLocationThinLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
          value
  ...
  private static final AtomicLongFieldUpdater<VersionedLocalRowLocationThinLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedLocalRowLocationThinLRURegionEntryHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedLocalRowLocationThinLRURegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedLocalRowLocationThinLRURegionEntryHeap.class;
    }
