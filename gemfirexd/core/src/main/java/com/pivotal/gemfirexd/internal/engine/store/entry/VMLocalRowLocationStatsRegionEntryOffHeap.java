...
public class VMLocalRowLocationStatsRegionEntryOffHeap extends RowLocationStatsRegionEntry
    implements OffHeapRegionEntry
{
  public VMLocalRowLocationStatsRegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationStatsRegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationStatsRegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsRegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsRegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsRegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsRegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private final static AtomicLongFieldUpdater<VMLocalRowLocationStatsRegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationStatsRegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationStatsRegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationStatsRegionEntryOffHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedLocalRowLocationStatsRegionEntryOffHeap.getEntryFactory();
    }
    @Override
    public RegionEntryFactory makeOnHeap() {
      return VMLocalRowLocationStatsRegionEntryHeap.getEntryFactory();
    }
  };
