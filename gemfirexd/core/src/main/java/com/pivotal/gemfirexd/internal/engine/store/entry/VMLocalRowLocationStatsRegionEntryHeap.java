...
public class VMLocalRowLocationStatsRegionEntryHeap extends RowLocationStatsRegionEntry
{
  public VMLocalRowLocationStatsRegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
          value
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationStatsRegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationStatsRegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsRegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsRegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsRegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsRegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationStatsRegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationStatsRegionEntryHeap.class;
    }
