...
{
  public VMBucketRowLocationStatsDiskLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMBucketRowLocationStatsDiskLRURegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMBucketRowLocationStatsDiskLRURegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMBucketRowLocationStatsDiskLRURegionEntryHeap(context, key, value);
    }
