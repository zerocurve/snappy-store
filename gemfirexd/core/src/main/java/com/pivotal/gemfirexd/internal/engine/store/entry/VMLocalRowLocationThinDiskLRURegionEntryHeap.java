...
public class VMLocalRowLocationThinDiskLRURegionEntryHeap extends RowLocationThinDiskLRURegionEntry
{
  public VMLocalRowLocationThinDiskLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationThinDiskLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinDiskLRURegionEntryHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationThinDiskLRURegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationThinDiskLRURegionEntryHeap.class;
    }
