...
{
  public VMLocalRowLocationThinDiskRegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationThinDiskRegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinDiskRegionEntryOffHeap.class, "lastModified");
  ...
  private final static AtomicLongFieldUpdater<VMLocalRowLocationThinDiskRegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinDiskRegionEntryOffHeap.class, "ohAddress");
  @Override
