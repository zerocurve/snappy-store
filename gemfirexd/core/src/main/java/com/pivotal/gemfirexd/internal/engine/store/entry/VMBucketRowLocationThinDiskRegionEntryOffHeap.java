...
public class VMBucketRowLocationThinDiskRegionEntryOffHeap extends RowLocationThinDiskRegionEntry
    implements OffHeapRegionEntry
{
  public VMBucketRowLocationThinDiskRegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMBucketRowLocationThinDiskRegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationThinDiskRegionEntryOffHeap.class, "lastModified");
  ...
  private final static AtomicLongFieldUpdater<VMBucketRowLocationThinDiskRegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationThinDiskRegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMBucketRowLocationThinDiskRegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMBucketRowLocationThinDiskRegionEntryOffHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedBucketRowLocationThinDiskRegionEntryOffHeap.getEntryFactory();
    }
    @Override
    public RegionEntryFactory makeOnHeap() {
      return VMBucketRowLocationThinDiskRegionEntryHeap.getEntryFactory();
    }
  };
