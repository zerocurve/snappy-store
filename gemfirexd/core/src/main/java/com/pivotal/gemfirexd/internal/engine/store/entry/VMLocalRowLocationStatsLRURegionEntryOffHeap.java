...
public class VMLocalRowLocationStatsLRURegionEntryOffHeap extends RowLocationStatsLRURegionEntry
    implements OffHeapRegionEntry
{
  public VMLocalRowLocationStatsLRURegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationStatsLRURegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationStatsLRURegionEntryOffHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsLRURegionEntryOffHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsLRURegionEntryOffHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMLocalRowLocationStatsLRURegionEntryOffHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMLocalRowLocationStatsLRURegionEntryOffHeap.class, "missCount");
  @Override
  ...
  private final static AtomicLongFieldUpdater<VMLocalRowLocationStatsLRURegionEntryOffHeap> ohAddrUpdater =
      AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationStatsLRURegionEntryOffHeap.class, "ohAddress");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationStatsLRURegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationStatsLRURegionEntryOffHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedLocalRowLocationStatsLRURegionEntryOffHeap.getEntryFactory();
    }
    @Override
    public RegionEntryFactory makeOnHeap() {
      return VMLocalRowLocationStatsLRURegionEntryHeap.getEntryFactory();
    }
  };
