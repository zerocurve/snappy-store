...
public class VMBucketRowLocationThinLRURegionEntryHeap extends RowLocationThinLRURegionEntry
{
  public VMBucketRowLocationThinLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
          value
  ...
  private static final AtomicLongFieldUpdater<VMBucketRowLocationThinLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationThinLRURegionEntryHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMBucketRowLocationThinLRURegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMBucketRowLocationThinLRURegionEntryHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedBucketRowLocationThinLRURegionEntryHeap.getEntryFactory();
    }
    @Override
