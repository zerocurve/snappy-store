...
public class VMLocalRowLocationThinDiskRegionEntryHeap extends RowLocationThinDiskRegionEntry
{
  public VMLocalRowLocationThinDiskRegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMLocalRowLocationThinDiskRegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMLocalRowLocationThinDiskRegionEntryHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMLocalRowLocationThinDiskRegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMLocalRowLocationThinDiskRegionEntryHeap.class;
    }
