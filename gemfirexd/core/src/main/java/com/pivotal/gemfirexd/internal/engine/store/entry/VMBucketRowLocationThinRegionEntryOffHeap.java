...
public class VMBucketRowLocationThinRegionEntryOffHeap extends RowLocationThinRegionEntry
    implements OffHeapRegionEntry
{
  public VMBucketRowLocationThinRegionEntryOffHeap (RegionEntryContext context, Object key,
    @Retained
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VMBucketRowLocationThinRegionEntryOffHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMBucketRowLocationThinRegionEntryOffHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VMBucketRowLocationThinRegionEntryOffHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VMBucketRowLocationThinRegionEntryOffHeap.class;
    }
    public RegionEntryFactory makeVersioned() {
      return VersionedBucketRowLocationThinRegionEntryOffHeap.getEntryFactory();
    }
    @Override
    public RegionEntryFactory makeOnHeap() {
      return VMBucketRowLocationThinRegionEntryHeap.getEntryFactory();
    }
  };
