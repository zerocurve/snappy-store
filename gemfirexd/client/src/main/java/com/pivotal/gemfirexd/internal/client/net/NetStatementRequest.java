/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.NetStatementRequest
...
import com.pivotal.gemfirexd.internal.client.am.Lob;
...
public class NetStatementRequest extends NetPackageRequest implements StatementRequestInterface {
    ...
    public void writePrepareDescribeOutput(NetStatement materialStatement,
        ...
        buildPRPSQLSTT(section,
                ...
                true, //sendTypsqlda
// GemStone changes BEGIN
                materialStatement.statement_.isPreparedStatement_
                    || materialStatement.statement_.isCallMode(),
                    needStatementUUID, 
// GemStone changes END
                ((section != null && section.isSingleHopInfoRequired()) ? 
                    CodePoint.TYPSQLDA_X_OUTPUT_AND_SINGLEHOP_INFO :  CodePoint.TYPSQLDA_X_OUTPUT));  //typsqlda
    ...
    {
// GemStone changes BEGIN
      writeExecute(materialPreparedStatement, section, parameterMetaData,
          inputs, numInputColumns, outputExpected, false, chained);
    }
...
// GemStone changes END
    ...
    public void writeOpenQuery(NetPreparedStatement materialPreparedStatement,
                               ...
                               int resultSetType,
                               int numInputColumns,
                               com.pivotal.gemfirexd.internal.client.am.ColumnMetaData parameterMetaData,
...
//KATHEY CHECK
                                 ...
                                 Object[] inputs) throws SqlException // chain is for blobs
    {
        ...
        fetchSize = (fetchSize == 0) ? com.pivotal.gemfirexd.internal.client.am.Configuration.defaultFetchSize : fetchSize;
...
/*
  public void writeSetGenericSQLSetInfo (com.pivotal.gemfirexd.internal.client.am.SetGenericSQLSetPiggybackCommand setGenericSQLSetPiggybackCommand,
                                  com.pivotal.gemfirexd.internal.client.am.JDBCSection section) throws SqlException
  {
...
// GemStone changes END
        ...
        buildPKGNAMCSN(section);
// GemStone changes BEGIN
        if (sendRtnsqlda || !isPrepared) {
          buildRTNSQLDA(sendRtnsqlda, isPrepared);
        }
        /* (original code)
        if (sendRtnsqlda) {
            buildRTNSQLDA();
...
// GemStone changes BEGIN
  void buildGETSTMTID(Section section) throws SqlException {
//    createCommand();
//    markLengthBytes(CodePoint.GETSTMTID);
//    buildPKGNAMCSN(section);
//    updateLengthBytes();
    writeScalar1Byte(CodePoint.GETSTMTID, 0/*ignored*/);
  }
// GemStone changes END
...
// GemStone changes END
        ...
        if (sendOutexp) {
// GemStone changes BEGIN
            buildOUTEXP(outexp, batchOutput);
            /* (original code)
            buildOUTEXP(outexp);
            */
// GemStone changes END
    ...
    boolean buildSQLDTAcommandData(int numInputColumns,
        ...
        buildFDODTA(numInputColumns,
                protocolTypesAndLengths,
                inputRow, parameterMetaData /* GemStoneAddition */);
...
/////////// perf end
    ...
    private void buildFDODTA(int numVars,
                             int[][] protocolTypesAndLengths,
                             Object[] inputs,
                             ColumnMetaData parameterMetaData /* GemStoneAddition */) throws SqlException {
        try
        {
                    ...
                    case DRDAConstants.DRDA_TYPE_NLONGMIX:
                        ...
                        if (o == null) {
                            writeSingleorMixedCcsidLDString((String) inputs[i], netAgent_.typdef_.getCcsidMbcEncoding(),
                                parameterMetaData.getColumnLabel(i + 1) /* GemStoneAddition */);
            ...
            if (extdtaPositions_ != null) {
                ...
                for (int i = 0; i < extdtaPositions_.size(); i++) {
                    ...
                    if (parameterType == Types.BLOB
                        ...
                        boolean isExternalBlob = !(b instanceof com.pivotal.gemfirexd.internal.client.am.Blob);
                        if (isExternalBlob) {
                            try {
                    ...
                    // the follow types are possible due to promotion to CLOB
                        ...
                        boolean isExternalClob = !(c instanceof com.pivotal.gemfirexd.internal.client.am.Clob);
...
// GemStone changes BEGIN
    private void buildOUTEXP(boolean outputExpected, boolean batchOutput)
        throws SqlException {
      if (!batchOutput) {
        if (outputExpected) {
        ...
        if (!outputExpected) {
          writeScalar1Byte(CodePoint.OUTEXP, CodePoint.FALSE
...
// GemStone changes END
    ...
    //   sqlam must support this parameter for the command, method will not check.
// GemStone changes BEGIN
    private void buildRTNSQLDA(boolean rtnSqlda, boolean isPrepared)
        throws SqlException {
      byte flag = rtnSqlda ? CodePoint.TRUE : CodePoint.FALSE;
      if (!isPrepared) {
        flag |= CodePoint.RTNSQLDA_UNPREPARED;
      }
      if (flag != CodePoint.FALSE) {
        writeScalar1Byte(CodePoint.RTNSQLDA, flag);
      }
    }
    /* (original code)
...
// GemStone changes END
    ...
    private int checkFetchsize(int fetchSize, int resultSetType) {
        ...
        if (resultSetType != java.sql.ResultSet.TYPE_FORWARD_ONLY && fetchSize == 0) {
            fetchSize = com.pivotal.gemfirexd.internal.client.am.Configuration.defaultFetchSize;
        }
        return fetchSize;
    }
