/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.CodePoint
...
// GemStone changes BEGIN
    ...
    // Combined with RTNSQLDA boolean, indicates that an unprepared statement
    // has been executed from the client.
...
// GemStone changes END
    ...
    // Gemstone changes BEGIN
    // TYPSQLDA - Extended Output SQLDA + Single Hop also
 ...
 // GemStone changes BEGIN
    // A modified codepoint for commit is being used
    // so that the server knows that it has to read 
    // a set of regions as well as part of commit
...
//GemStone changes END
    ...
    public static final int SQLDARDI = 0x2416;
    ...
    // Gemstone changes BEGIN
    // Same as PKGNAMCSN but an indication to read bucket ids
    // too.
    static final int PKGNAMCSN_SHOP = 0x3000;
    
    // Same as PKGNAMCSN_SHOP but an indication to read sql 
    // string too.
    static final int PKGNAMCSN_SHOP_WITH_STR = 0x3001;
    
    //get statement ID from the server
...
// GemStone changes BEGIN
    // Piggy backed data can have txid information
    static final int PBSD_TXID = 0xC003;
    // server versions
    static final int PBSD_SVRVER = 0xC004;
    // regions affected in transactions
