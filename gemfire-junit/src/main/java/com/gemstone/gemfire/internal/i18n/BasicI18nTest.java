...
public class BasicI18nTest extends TestCase {
  ...
  static final StringId messageId
         = LocalizedStrings.TESTING_THIS_IS_A_TEST_MESSAGE;
  static final String englishMessage = "This is a test message.";
  static final String japaneseMessage = "msgID " + ((StringIdImpl)messageId).id + ": " + "ã�“ã‚Œã�¯ãƒ†ã‚¹ãƒˆãƒ¡ãƒƒã‚»ãƒ¼ã‚¸ã�§ã�‚ã‚‹ã€‚";

  static final Integer messageArg = new Integer(1);
  static final StringId messageIdWithArg
         = LocalizedStrings.TESTING_THIS_MESSAGE_HAS_0_MEMBERS;
  static final String englishMessageWithArg = "Please ignore: This message has 1 members.";
  static final String japaneseMessageWithArg
         = "msgID " + ((StringIdImpl)messageIdWithArg).id + ": Please ignore: ã�“ã�®ãƒ¡ãƒƒã‚»ãƒ¼ã‚¸ã�« 1 ãƒ¡ãƒ³ãƒ�ãƒ¼ã�Œã�‚ã‚‹ã€‚";
  static final String englishMessageWithArgMissing
         = "Please ignore: This message has {0} members.";
  static final String japaneseMessageWithArgMissing
         = "msgID " + ((StringIdImpl)messageIdWithArg).id + ": Please ignore: ã�“ã�®ãƒ¡ãƒƒã‚»ãƒ¼ã‚¸ã�« {0} ãƒ¡ãƒ³ãƒ�ãƒ¼ã�Œã�‚ã‚‹ã€‚";
   ...
   * </code>
   */
  public void verifyStringsAreProperlyEscaped(Locale loc) {
  ...
  public void testDefaults() {
    ...
    assertTrue(currentLang.equals(expectedLang));
  }
