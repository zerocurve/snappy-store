...
public class LocalizedStrings extends ParentLocalizedStrings {
  ...
  public static final StringId AbstractDistributionConfig_MEMORY_SIZE = new StringIdImpl(90008, "Total memory which server regions and various operator can occupy");
}
