...
public class ExternalStrings {
  ...
  public static final StringId AUTH_AUTHENTICATION_FAILED_FOR_0_1_SEE_COORDINATOR_2_LOGS_FOR_DETAILS = new GFStringIdImpl(15739, "Authentication failed for {0}: {1}. See coordinator [{2}] logs for details.");
