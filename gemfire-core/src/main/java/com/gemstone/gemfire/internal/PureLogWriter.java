...
//	}
    ...
    */
    @Override
    protected void put(int msgLevel, StringId msgId, Object[] params,
              Throwable ex) {
    ...
    // split out header writing portion for GemFireXD logging
    ...
    // made public for use by GemFireXD logging
