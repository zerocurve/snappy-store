...
public class VersionedThinDiskLRURegionEntryHeap extends VMThinDiskLRURegionEntry
    implements VersionStamp
{
  public VersionedThinDiskLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
  ...
  private static final AtomicLongFieldUpdater<VersionedThinDiskLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VersionedThinDiskLRURegionEntryHeap.class, "lastModified");
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    public final RegionEntry createEntry(RegionEntryContext context, Object key, Object value) {
      return new VersionedThinDiskLRURegionEntryHeap(context, key, value);
    }
    public final Class<?> getEntryClass() {
      return VersionedThinDiskLRURegionEntryHeap.class;
    }
