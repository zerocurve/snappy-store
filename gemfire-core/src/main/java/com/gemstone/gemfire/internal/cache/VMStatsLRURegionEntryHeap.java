...
{
  public VMStatsLRURegionEntryHeap (RegionEntryContext context, Object key,
    Object value
      ) {
    super(context,
          value
  ...
  private static final AtomicLongFieldUpdater<VMStatsLRURegionEntryHeap> lastModifiedUpdater
    = AtomicUpdaterFactory.newLongFieldUpdater(VMStatsLRURegionEntryHeap.class, "lastModified");
  ...
  private static final AtomicIntegerFieldUpdater<VMStatsLRURegionEntryHeap> hitCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMStatsLRURegionEntryHeap.class, "hitCount");
  private static final AtomicIntegerFieldUpdater<VMStatsLRURegionEntryHeap> missCountUpdater
    = AtomicUpdaterFactory.newIntegerFieldUpdater(VMStatsLRURegionEntryHeap.class, "missCount");
  @Override
  ...
  private static RegionEntryFactory factory = new RegionEntryFactory() {
    ...
    public final Class<?> getEntryClass() {
      return VMStatsLRURegionEntryHeap.class;
    }
