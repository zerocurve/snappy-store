...
public class CliStrings {
  ...
  public static final String ATTACH_API_IN_0_NOT_FOUND_ERROR_MESSAGE = "The JDK {0} is required by 'start', 'status' and 'stop' commands for Locators and Servers. Please set JAVA_HOME to JDK Directory or add the JDK {0} to the classpath, restart Gfsh and try again.";
  ...
  public static final String ALTER_RUNTIME_CONFIG__LOG__LEVEL__HELP = "Log level. Valid values are: none, error, info, config , fine, finer and finest.";
  ...
  public static final String CONNECT__DEFAULT_BASE_URL = "http://localhost:8080/gemfire/v1";
  public static final String CONNECT__URL__HELP = "Indicates the base URL to the Manager's HTTP service.  For example: http://<host>:<port>/ Default is " + CONNECT__DEFAULT_BASE_URL;
  ...
  public static final String CREATE_ASYNC_EVENT_QUEUE__BATCH_SIZE__HELP = "Maximum number of messages that a batch can contain.";
  ...
  public static final String CREATE_DISK_STORE__DIRECTORY_AND_SIZE__HELP = "Directories where the disk store files will be written.  Optionally, directory names may be followed by # and the maximum number of megabytes that the disk store can use in the directory.  Example: --dir=/data/ds1 --dir=/data/ds2#5000";
  ...
  public static final String DESTROY_FUNCTION__ONGROUP = "group";
  public static final String DESTROY_FUNCTION__ONGROUP__HELP = "Group of members from which this function will be unregistered.";
  ...
  public static final String DESTROY_FUNCTION__MSG__PROVIDE_OPTION = "Provide either --group or --member";
  ...
  public static final String EXECUTE_FUNCTION__ONGROUP = "group";
  public static final String EXECUTE_FUNCTION__ONGROUP__HELP = "Group of members on which the function will be executed.";
  ...
  public static final String EXECUTE_FUNCTION__MSG__MISSING_OPTIONS = "Provide one of region/member/group";
  public static final String EXECUTE_FUNCTION__MSG__OPTIONS = "Provide Only one of region/member/group";
  ...
  public static final String EXECUTE_FUNCTION__MSG__ON_GROUP_NOT_SUPPORTED = "Function Execution on group is not yet supported.";
  ...
  public static final String EXECUTE_FUNCTION__MSG__GROUP_0_HAS_NO_MEMBERS = "Group : {0} has no members";
  ...
  public static final String SHUTDOWN__HELP = "Stop all members hosting a cache. This command does not shut down any running locators. To shut down a locator, use the \""+CliStrings.STOP_LOCATOR+"\" command.";
  public static final String SHUTDOWN__TIMEOUT = "time-out";
  public static final String SHUTDOWN__TIMEOUT__HELP = "Time to wait (in seconds) for a graceful shutdown before members are forcefully stopped.";
  public static final String SHUTDOWN__MSG__CANNOT_EXECUTE = "Cannot execute";
  public static final String SHUTDOWN__MSG__ERROR = "Error in shut down";
  public static final String SHUTDOWN__MSG__SUCESS = "Sucessfully shut down";
  ...
  public static final String START_PULSE__RUN = "Running GemFire Pulse";
  ...
  public static final String START_JCONSOLE__RUN = "Running JDK JConsole";
  ...
  public static final String START_JVISUALVM__RUN = "Running JDK VisualVM";
  ...
  public static final String START_SERVER__CLASSPATH__HELP = "Location of user classes required by the Cache Server. This path is appended to the current classpath.";
  ...
  public static final String START_VSD__NOT_FOUND_ERROR_MESSAGE = "The location of VSD could not be found.  Please ensure VSD was properly installed to GemFire home (%1$s).";
  public static final String START_VSD__RUN = "Running GemFire Visual Statistics Display (VSD)";
  ...
  public static final String START_DATABROWSER__NOT_FOUND_ERROR_MESSAGE = "The location of DataBrowser could not be found.  Please ensure DataBrowser was properly installed to GemFire home (%1$s).";
  public static final String START_DATABROWSER__RUN = "Running GemFire DataBrowser";
