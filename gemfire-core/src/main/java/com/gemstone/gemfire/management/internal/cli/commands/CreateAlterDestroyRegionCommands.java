 ...
 * @since 7.0
 */
public class CreateAlterDestroyRegionCommands implements CommandMarker {
  ...
  public Result alterRegion(
    ...
    try {
      ...
      if (groups != null) {
        validateGroups(cache, groups.split(","));
      }
      ...
      if (entryExpirationIdleTime != null || entryExpirationIdleTimeAction != null) {
        ...
        if (entryExpirationIdleTimeAction != null && entryExpirationIdleTimeAction.isEmpty()) {
      ...
      if (entryExpirationTTL != null || entryExpirationTTLAction != null) {
        ...
        if (entryExpirationTTLAction != null && entryExpirationTTLAction.isEmpty()) {
      ...
      if (regionExpirationIdleTime != null || regionExpirationIdleTimeAction != null) {
        ...
        if (regionExpirationIdleTimeAction != null && regionExpirationIdleTimeAction.isEmpty()) {
      ...
      if (regionExpirationTTL != null || regionExpirationTTLAction != null) {
        ...
        if (regionExpirationTTLAction != null && regionExpirationTTLAction.isEmpty()) {
