...
//      this.rejectionMessage = "Peer " + getSender() + " has no network interfaces";
    ...
    if (this.fromDataProblems != null) {
      dm.getLoggerI18n().info(LocalizedStrings.ONE_ARG, this.fromDataProblems);
    }
    ...
    if (proc != null) {
      if (this.rejectionMessage != null) {
        ...
        if (DistributionManager.VERBOSE) {
          ...
          logger.info(LocalizedStrings.StartupResponseMessage_0__PROCESSED__1, new Object[] {proc, this});
        }
      }
    } // proc != null
  }
