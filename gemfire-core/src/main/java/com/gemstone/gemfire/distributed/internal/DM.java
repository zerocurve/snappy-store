...
public interface DM extends ReplySender {
  ...
  /**
   * Returns the least version of the members in the set.
   * @param members the members to evaluate
   * @return the least common version
   * @since 8.1
   */
  ...
  /**
   * Gets this distribution manager's logger. Messages can use this method
   * to log diagnostic info about how the message is processed.
   */
