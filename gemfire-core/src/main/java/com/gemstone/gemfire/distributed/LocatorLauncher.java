...
public final class LocatorLauncher extends AbstractLauncher<String> {
  ...
  private static final Map<Command, String> usageMap = new TreeMap<Command, String>();
  ...
  private static final AtomicReference<LocatorLauncher> INSTANCE = new AtomicReference<LocatorLauncher>();
